...
output "iothub_dps_shared_access_policies_enrollment_write" {
  ...
  value       = { for k, v in azurerm_iothub_dps_shared_access_policy.iothub_dps_shared_access_policies : k => v.enrollment_write }
}
output "iothub_dps_shared_access_policies_iothub_dps_name" {
  ...
  value       = { for k, v in azurerm_iothub_dps_shared_access_policy.iothub_dps_shared_access_policies : k => v.iothub_dps_name }
}
output "iothub_dps_shared_access_policies_name" {
  ...
  value       = { for k, v in azurerm_iothub_dps_shared_access_policy.iothub_dps_shared_access_policies : k => v.name }
}
output "iothub_dps_shared_access_policies_primary_connection_string" {
  ...
  value       = { for k, v in azurerm_iothub_dps_shared_access_policy.iothub_dps_shared_access_policies : k => v.primary_connection_string }
  sensitive   = true
}
output "iothub_dps_shared_access_policies_primary_key" {
  ...
  value       = { for k, v in azurerm_iothub_dps_shared_access_policy.iothub_dps_shared_access_policies : k => v.primary_key }
  sensitive   = true
}
output "iothub_dps_shared_access_policies_registration_read" {
  ...
  value       = { for k, v in azurerm_iothub_dps_shared_access_policy.iothub_dps_shared_access_policies : k => v.registration_read }
}
output "iothub_dps_shared_access_policies_registration_write" {
  ...
  value       = { for k, v in azurerm_iothub_dps_shared_access_policy.iothub_dps_shared_access_policies : k => v.registration_write }
}
output "iothub_dps_shared_access_policies_resource_group_name" {
  ...
  value       = { for k, v in azurerm_iothub_dps_shared_access_policy.iothub_dps_shared_access_policies : k => v.resource_group_name }
}
output "iothub_dps_shared_access_policies_secondary_connection_string" {
  ...
  value       = { for k, v in azurerm_iothub_dps_shared_access_policy.iothub_dps_shared_access_policies : k => v.secondary_connection_string }
  sensitive   = true
}
output "iothub_dps_shared_access_policies_secondary_key" {
  ...
  value       = { for k, v in azurerm_iothub_dps_shared_access_policy.iothub_dps_shared_access_policies : k => v.secondary_key }
  sensitive   = true
}
output "iothub_dps_shared_access_policies_service_config" {
  ...
  value       = { for k, v in azurerm_iothub_dps_shared_access_policy.iothub_dps_shared_access_policies : k => v.service_config }
}
